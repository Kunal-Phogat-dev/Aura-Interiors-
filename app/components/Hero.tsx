    ...
    <section className="relative h-[750vh]">
      ...
      >
        <div className="w-full px-6 md:px-12 lg:px-20 flex flex-col items-center md:items-start text-center md:text-left pointer-events-auto">
          ...
          <div 
            className={`transition-all ease-out ${expandProgress === 1 ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8 pointer-events-none"}`}
            style={{
              transitionDelay: expandProgress === 1 ? '2000ms' : '0ms',
              transitionDuration: expandProgress === 1 ? '1000ms' : '150ms'
            }}
          >
